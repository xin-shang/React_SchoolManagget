...
import CourseSelect from './Screens/CoursePage';
...
function TimerSelectorStack(){
  return (
    <Stack.Navigator initialRouteName="TimerSelector">
  ...
  return (
    <NavigationContainer>
      ...
      <Tab.Screen
        ...
        {/*<Tab.Screen
          name = "TimerSelectorStack"
          component={TimerSelectorStack}
          options = {{
            headerShown: false,
            tabBarLabel: 'StudyTimer',
            tabBarIcon: ({color,size}) => (
              <MaterialCommunityIcons
                name= "clock"
                color={color}
